...
import com.xunqi.common.constant.AuthServiceConstant;
...
import static com.xunqi.common.constant.AuthServiceConstant.LOGIN_USER;
...
public class LoginController {
    ...
    public R sendCode(@RequestParam("phone") String phone) {
        ...
        stringRedisTemplate.opsForValue().set(AuthServiceConstant.SMS_CODE_CACHE_PREFIX+phone,
    ...
    public String register(@Valid UserRegisterVo vos, BindingResult result,
        ...
        //获取存入Redis里的验证码
        String redisCode = stringRedisTemplate.opsForValue().get(AuthServiceConstant.SMS_CODE_CACHE_PREFIX + vos.getPhone());
        if (!StringUtils.isEmpty(redisCode)) {
            //截取字符串
            if (code.equals(redisCode.split("_")[0])) {
                //删除验证码;令牌机制
                stringRedisTemplate.delete(AuthServiceConstant.SMS_CODE_CACHE_PREFIX+vos.getPhone());
